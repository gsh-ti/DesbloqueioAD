...
const response = await fetch(
  "https://condo-dealt-bikes-impressed.trycloudflare.com/desbloquearUsuario",
  {
    method: "POST",
  ...
  async function chamaMicrosoft() {
    window.location.href = "https://condo-dealt-bikes-impressed.trycloudflare.com/auth/login";
  }
